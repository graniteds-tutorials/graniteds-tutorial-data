...
public class AccountDetailActivity extends FragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		AndroidContextManager.getContext(this, getIntent().getExtras()).set(this);
		...
		if (savedInstanceState == null) {
			...
			getSupportFragmentManager().beginTransaction().add(R.id.account_detail_container, fragment).commit();
		}
	}
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case android.R.id.home:
			...
			//
			NavUtils.navigateUpTo(this, new Intent(this, AccountListActivity.class));
			return true;
		}
