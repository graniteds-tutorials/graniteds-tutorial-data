...
This tutorial shows how to build a simple data application that managed a database of user accounts. All connected clients are
...
NOTE
----
JBoss AS 7.1 has bugs or limitations which prevent the tutorial from working out of the box, thus using JBoss AS 7.2 is required.
